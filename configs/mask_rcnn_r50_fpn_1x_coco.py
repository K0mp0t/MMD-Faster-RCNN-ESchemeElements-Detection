model = dict(
    ...
    roi_head=dict(  # RoIHead encapsulates the second stage of two-stage/cascade detectors.
        ...
        bbox_head=dict(  # Config of box head in the RoIHead.
            ...
            num_classes=30,  # Number of classes for classification
        ...
        mask_head=dict(  # Mask prediction head
            ...
            num_classes=30,  # Number of class to be segmented.
...
train_pipeline = [  # Training pipeline
    ...
    dict(
        ...
        img_scale=(1400, 800),  # The largest scale of image
        keep_ratio=True
    ),  # whether to keep the ratio between height and width.
    dict(
        type='RandomFlip',  # Augmentation pipeline that flip the images and their annotations
        flip_ratio=0.0),  # The ratio or probability to flip
    dict(
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(1400, 800),  # Decides the largest scale for testing, used for the Resize pipeline
...
data = dict(
    ...
    train=dict(  # Train dataset config
        ...
        ann_file=f'E:/Peter/Scheme/cocosplit/train.json',  # Path of annotation file
        img_prefix=f'E:/Peter/Scheme/scheme',  # Prefix of image path
        pipeline=train_pipeline),
    val=dict(  # Validation dataset config
        type='CocoDataset',
        ann_file=f'E:/Peter/Scheme/cocosplit/test.json',
        img_prefix=f'E:/Peter/Scheme/scheme',
...
work_dir = f'E:/Peter/Scheme/logs'  # Directory to save the model checkpoints and logs for the current experiments.